...
for id in class_indict.values():
    ...
    # pytorch folder
    src_path = '/media/wall/4TB_HDD/full_dataset/0511_dataset/pill/train/all_pill_20_pytorch/{capsule_folder}/'.format(capsule_folder=id)
    dst_path = '/media/wall/4TB_HDD/full_dataset/0511_dataset/pill/train/pill_pytorch/{capsule_folder}/'.format(capsule_folder=id)
